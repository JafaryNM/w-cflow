...
import { UtensilsCrossed, Sprout, Layers } from "lucide-react";
...
const EXPERTISE_CARDS = [
  {
    ...
    icon: <UtensilsCrossed className="h-10 w-10 text-[#E85D5D]" strokeWidth={1.8} />,
  },
  {
    id: "agro",
    ...
    icon: <Sprout className="h-10 w-10 text-[#E85D5D]" strokeWidth={1.8} />,
  },
  {
    id: "soil",
    title: "Soil Analysis",
    ...
    positionClass: "translate-y-0",
    icon: <Layers className="h-10 w-10 text-[#E85D5D]" strokeWidth={1.8} />,
  },
];
